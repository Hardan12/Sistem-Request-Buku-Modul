...
<?php
    ...
    <body>
        <div class="chart-container">
            <h2>Jumlah Inputan per Judul Modul</h2>
            <canvas id="inputChart"></canvas>
        </div>
    
        <?php
        require_once __DIR__ . '/../../controllers/kurvamc.php';
        require_once __DIR__ . '/../../core/db.php';
    
        $kurvamc = new kurvamc($pdo);
        $inputCounts = $kurvamc->getInputCountByTitle();
    
        $titles = [];
        $counts = [];
    
        foreach ($inputCounts as $inputCount) {
            $titles[] = $inputCount['modul_judul'];
