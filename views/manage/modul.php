...
require_once '../../controllers/ManageStatusController.php';
...
$moduleRequests = $manageStatusController->getAllModuleRequests($page, $limit, $search, $order);
$totalModuleRequests = $manageStatusController->countAllModuleRequests($search);
$totalModulePages = ceil($totalModuleRequests / $limit);
?>
                            ...
                            <td>
                                <form action="../../controllers/ManageStatusController.php" method="POST">
                                    ...
                                    <select name="status" class="form-control">
                                        ...
                                        <option value="Dicetak" <?php if ($request['status'] == 'Dicetak') echo 'selected'; ?>>Dicetak</option>
        ...
        <div class="pagination">
            <nav aria-label="Page navigation example">
                <ul class="pagination justify-content-center">
                    ...
                    <?php for ($i = 1; $i <= $totalModulePages; $i++) : ?>
